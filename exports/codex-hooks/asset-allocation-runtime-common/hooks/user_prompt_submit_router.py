...
LANES = (
    ...
    (
        ...
        "delivery-orchestrator-agent -> strategy-validation-model-risk-reviewer -> relevant implementation/QA agents",
    ),
    (
        ...
        "delivery-orchestrator-agent -> execution-quality-tca-analyst -> relevant implementation/QA agents",
    ),
    (
        ...
        "delivery-orchestrator-agent -> portfolio-risk-exposure-controller -> relevant implementation/QA agents",
    ),
    (
        ...
        "delivery-orchestrator-agent -> performance-attribution-return-decomposition-analyst -> relevant implementation/QA agents",
    ),
    (
        ...
        "delivery-orchestrator-agent -> thesis-drift-what-changed-agent -> relevant implementation/QA agents",
    ),
    (
        ...
        "delivery-orchestrator-agent -> trader-behavior-process-reviewer -> relevant implementation/QA agents",
    ),
    (
        "trading-compliance",
        (
        ...
        "delivery-orchestrator-agent -> trading-compliance-surveillance-agent -> relevant implementation/QA agents",
    ),
    (
        ...
        "delivery-orchestrator-agent -> regime-scenario-analyst -> relevant implementation/QA agents",
    ),
    (
        ...
        "delivery-orchestrator-agent -> catalyst-calendar-monitor -> relevant implementation/QA agents",
    ),
    (
    ...
    (
        ...
        "delivery-orchestrator-agent -> research-librarian-evidence-packager -> relevant implementation/QA agents",
    ),
    (
        "review",
