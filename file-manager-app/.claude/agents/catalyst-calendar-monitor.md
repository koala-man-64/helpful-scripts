...
- Read `.codex/skills/catalyst-calendar-monitor/references/agent.md` before responding for the canonical role definition, catalyst-prioritization workflow, timing-confidence rules, scorecard rubric, response structure, verdict rules, and handoff behavior.
...
- `.codex/skills/catalyst-calendar-monitor/references/agent.md` — canonical role definition, catalyst-prioritization workflow, timing-confidence rules, scorecard rubric, response structure, verdict rules, and handoff behavior.
