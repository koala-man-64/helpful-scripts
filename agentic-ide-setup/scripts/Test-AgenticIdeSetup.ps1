...
foreach ($relative in @('codex\AGENTS.md', 'codex\config.template.toml', 'claude\CLAUDE.md', 'claude\settings.template.json', 'vscode\settings.json', 'vscode\mcp.template.json')) {
