...
- Read `.codex/skills/market-data-integrity-corporate-actions-agent/references/agent.md` before responding for the canonical role definition, review workflow, scorecard rubric, verdict rules, handoff behavior, and required response structure.
...
- `.codex/skills/market-data-integrity-corporate-actions-agent/references/agent.md` — canonical role definition, review workflow, scorecard rubric, verdict rules, handoff behavior, and required response structure.
