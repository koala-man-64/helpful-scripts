...
- Prefer automated, low-risk evidence:
  - Optionally run `python3 .claude/skills/project-workflow-auditor-agent/scripts/audit_snapshot.py --repo . --out audit_snapshot.json` and reference the output in the report.
