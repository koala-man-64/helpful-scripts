...
2. Use `python ~/.claude/agents/resources/gateway-agent/scripts/gateway_ledger.py snapshot --project-root <PROJECT_ROOT>` before any write.
...
```bash
python ~/.claude/agents/resources/gateway-agent/scripts/gateway_ledger.py append \
