...
```bash
python3 .claude/skills/code-drift-sentinel/scripts/codedrift_sentinel.py --mode audit
python3 .claude/skills/code-drift-sentinel/scripts/codedrift_sentinel.py --mode recommend
python3 .claude/skills/code-drift-sentinel/scripts/codedrift_sentinel.py --mode auto-remediate
```
