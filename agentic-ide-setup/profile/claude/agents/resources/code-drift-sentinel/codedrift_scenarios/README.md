...
```bash
python3 ~/.claude/agents/resources/code-drift-sentinel/scripts/run_scenarios.py --list
python3 ~/.claude/agents/resources/code-drift-sentinel/scripts/run_scenarios.py --validate
```
