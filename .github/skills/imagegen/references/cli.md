...
export IMAGE_GEN=".github/skills/.system/imagegen/scripts/image_gen.py"
```
...
- Built-in-first transparent image workflow: `SKILL.md` and `.github/skills/.system/imagegen/scripts/remove_chroma_key.py`
